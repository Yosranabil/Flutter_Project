                              ...
                              children: [
                                Positioned(
                                  ...
                                  child: Column(
                                    children: [
                                      Image(
                                        image: (WeatherIcons[data?.condition] != null) ? AssetImage("${WeatherIcons[data?.condition]}") : const AssetImage('Assets/Icons/cloudy.png'),
                                        height: 210,
                                        width: 210,
                                        fit: BoxFit.cover,
                                      ),
                    ...
                    FutureBuilder(
                      ...
                      builder: (context, snapshot) {
                        if(snapshot.connectionState == ConnectionState.done)
                          {
                            return Image(
                              image: (WeatherIcons[data?.hours[0]['condition']['text']] != null) ? AssetImage(WeatherIcons[data?.hours[0]['condition']['text']]!) : const AssetImage('Assets/Icons/cloudy.png'),
                              height: 70,
                              width: 70,
                            );
                          }
